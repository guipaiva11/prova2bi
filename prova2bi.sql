...
values ("As Crônicas de Nárnia", "C.S Lewis", "1950", "disponivel", "Fantasia", "978-0064471190", "HarperCollins", "768", "Francês");
...
SELECT  quantidade_pagina
FROM Livros
WHERE quantidade_pagina > '650';
